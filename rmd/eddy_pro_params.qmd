...
calg_declination <- 13.5 # for calgary from https://www.ncei.noaa.gov/maps/historical_declination/
dir_mag_raw <- ec_direction_raw + suunto_declination # offset from magnetic north
ec_dir_final <- dir_mag_raw - calg_declination # offset from truenorth 
```
